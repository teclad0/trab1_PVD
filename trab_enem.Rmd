...
Além disso, os atributos CO_MUNICIPIO_PROVA e CO_UF_PROVA,  CO_MUNICIPIO_ESC	e CO_UF_ESC, CO_PROVA_CH	CO_PROVA_LC, CO_PROVA_CN	CO_PROVA_MT
possuem um valor bem próximo de 1 , sendo 0.99 para o r e 0.99 para o R². Isso se deve ao fato de que o código do município sempre contém o código da UF em que a prova foi realizada, como pode ser visto abaixo:
...
[ ]explicar pq as tx_resposta* foram retiradas
...
Verificando se existe algum valor que distoa dos dados aceitos para cada coluna 
numérica
```{r}
