...
summary(prcomp(na.omit(enem.df_numeric)))
```

Algo curioso encontra-se, pois o primeiro componente principal possui quase 99,9% da variância do dataset, fazendo com que os dois primeiros componentes resumam o dataset inteiro.

[TODO Igor: pensar melhor nessa análise do PCA]
